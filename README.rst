...
2. At your desired location create a directory titled ``kanban``
3. Open a terminal (Bash, zsh, Linux, or DOS) and cd to the ``kanban`` directory and type
   ``close https://github.com/Jon-Webb-79/kanban.git kanban``
4. Install with pip3
